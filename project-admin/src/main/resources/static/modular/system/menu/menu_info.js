...
MenuInfoDlg.showMenuSelectTree = function () {
    Feng.showInputTree("menuid", "menuContent", 15, 34);
};
...
$(function () {
    ...
    var ztree = new $ZTree("tree", "/menu/selectMenuTreeList");
...
layui.use(['form'], function () {
    ...
    form.on('submit(addmenu)', function (data) {
        var ajax = new $ax(MyObject.ctxPath + "/menu/add", function (data) {
            MyObject.success("添加成功！");
        }, function (data) {
            MyObject.error("添加失败!" + data.msg + "!");
        });
