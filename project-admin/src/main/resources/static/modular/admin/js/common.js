...
function layerOpenClose(title, url, w, h,fun) {
    if (title == null || title == '') {
        title = false;
    }
    ;
...
function showBigImg(obj) {
    var img = new Image();
    img.src = obj.src;
    var height = (img.height > 650) ? 740 : img.height + 90; //获取图片高度
    var width = (img.width > 650) ? 690 : img.width + 40;; //获取图片宽度
    var imgHtml = "<img src='" + obj.src + "' style='max-height: 650px; max-width: 650px'/>";
    //弹出层
