package com.mapscience.config.jwt;
...
import com.mapscience.core.util.common.JsonConvertUtil;
import com.mapscience.core.util.common.PropertiesUtil;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    private void response401(ServletRequest req, ServletResponse resp, String msg) {
        ...
        try {
            ...
            String data = JsonConvertUtil.objectToJson(new ResponseVal(ProjectStatusEnum.TOKEN_EXPIRED.getCode(), "无权访问(Unauthorized):" + msg));
            out.append(data);
        } catch (IOException e) {
            LOGGER.error("直接返回Response信息出现IOException异常:" + e.getMessage());
            throw new ProjectException(500, "直接返回Response信息出现IOException异常:" + e.getMessage());
        } finally {
            if (out != null) {
                out.close();
            }
