...
import com.mapscience.core.mutidatasource.DynamicDataSource;
import com.mapscience.core.mutidatasource.aop.MultiSourceExAop;
...
@Configuration
@ConditionalOnProperty(prefix = "project.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.mapscience.modular.*.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "project.muti-datasource")
