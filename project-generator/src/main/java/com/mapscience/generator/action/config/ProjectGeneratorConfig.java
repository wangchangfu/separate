...
public class ProjectGeneratorConfig extends AbstractGeneratorConfig {

    /**
     * 设置项目路径
     */
    protected void globalConfig() {
        globalConfig.setOutputDir("G:\\ttt");//写自己项目的绝对路径,注意具体到java目录
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.mapscience.modular.system.model");
        packageConfig.setMapper("com.mapscience.modular.system.mapper");
        packageConfig.setXml("com.mapscience.modular.system.mapper.mappers");
    }


    protected void contextConfig() {
        contextConfig.setProPackage("com.mapscience");
        contextConfig.setCoreBasePackage("com.mapscience");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("E:\\IdeaProjects\\separate\\project-admin");//写自己项目的绝对路径
