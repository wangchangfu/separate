...
public class ContextConfig {
    private String templatePrefixPath = "project-parent/advanced";
    private String projectPath = "E:\\IdeaProjects\\separate";//模板输出的项目目录
    ...
    private String proPackage = "com.mapscience";
    private String coreBasePackage = "com.mapscience.project.core";
    private String modelPackageName = "com.mapscience.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.mapscience.modular.system.mapper";    //model的dao
