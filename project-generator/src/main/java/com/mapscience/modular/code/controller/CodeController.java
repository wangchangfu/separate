...
public class CodeController {
    ...
    public ResponseVal generate(CodeProperties codeProperties) {
        codeProperties.setUrl("jdbc:mysql://192.168.1.154:3306/separate?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=UTC");
